	            ...
	            <div class="row">
	            	<div class="col-sm-3">
	            		<div class="card text-white bg-success mb-3">
						  	<div class="card-header text-center"><h4>Today Total Visitors</h4></div>
						  	<div class="card-body">
	            	...
	            	<div class="col-sm-3">
	            		<div class="card text-white bg-primary mb-3">
						  	<div class="card-header text-center"><h4>Yesterday Total Visitors</h4></div>
						  	<div class="card-body">
	            	...
	            	<div class="col-sm-3">
	            		<div class="card text-white bg-warning mb-3">
						  	<div class="card-header text-center"><h4>Last 7 Days Visitors</h4></div>
						  	<div class="card-body">
	            	...
	            	<div class="col-sm-3">
	            		<div class="card text-white bg-info mb-3">
						  	<div class="card-header text-center"><h4>Total Visitors Till Today</h4></div>
						  	<div class="card-body">
